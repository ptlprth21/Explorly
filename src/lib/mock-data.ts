...
export const packagesData: Omit<Package, 'id' | 'image' | 'aiReasoning'>[] = [
  ...
  },
  {
    ...
    type: 'City Break',
    difficulty: 'Easy',
    highlights: ['Burj Khalifa Observation Deck', 'Desert Safari Adventure', 'Shopping at Dubai Mall'],
    description: 'Experience the futuristic glamour and desert landscapes of Dubai. A city of superlatives, where modern architecture meets ancient traditions.',
    itinerary: [],
    inclusions: ['4-star hotel', 'Airport transfers', 'Desert Safari with BBQ dinner'],
    exclusions: ['International flights', 'Visa fees', 'Most meals'],
    availableDates: ['2025-11-05', '2025-12-20', '2026-01-25'],
  },
  {
...
export const reviews: Review[] = [
  ...
  { id: '22', packageId: 'modern-marvels-of-dubai', userName: 'Vera', rating: 5, comment: 'The desert safari was so much fun! The views from the Burj Khalifa are insane.', date: '2024-12-01T17:30:00Z', verified: true },
