...
export const countries: Country[] = [
    { name: 'Tanzania', flag: '🇹🇿', heroImage: 'https://picsum.photos/seed/tanzania-savannah/1920/1080', dataAiHint: 'tanzania savannah', tagline: 'The Soul of Africa', continent: 'Africa', culture: 'Rich in Maasai traditions and Swahili culture.', bestTime: 'Jun-Oct', currency: 'TZS', language: 'Swahili' },
    { name: 'Japan', flag: '🇯🇵', heroImage: 'https://picsum.photos/seed/japan-temple/1920/1080', dataAiHint: 'japan temple', tagline: 'Land of the Rising Sun', continent: 'Asia', culture: 'A unique blend of ancient traditions and futuristic technology.', bestTime: 'Mar-May, Sep-Nov', currency: 'JPY', language: 'Japanese' },
    { name: 'Peru', flag: '🇵🇪', heroImage: 'https://picsum.photos/seed/peru-machu-picchu/1920/1080', dataAiHint: 'peru machu picchu', tagline: 'Empire of Hidden Treasures', continent: 'South America', culture: 'Home to ancient Inca civilizations and vibrant local markets.', bestTime: 'Apr-Oct', currency: 'PEN', language: 'Spanish' },
    { name: 'Greece', flag: '🇬🇷', heroImage: 'https://picsum.photos/seed/greece-santorini/1920/1080', dataAiHint: 'greece santorini', tagline: 'The Cradle of Western Civilization', continent: 'Europe', culture: 'Mythology, philosophy, and stunning island life.', bestTime: 'Apr-Oct', currency: 'EUR', language: 'Greek' },
    { name: 'Canada', flag: '🇨🇦', heroImage: 'https://picsum.photos/seed/canada-rockies/1920/1080', dataAiHint: 'canada rockies', tagline: 'The Great White North', continent: 'North America', culture: 'Diverse landscapes and a multicultural mosaic.', bestTime: 'Jun-Sep', currency: 'CAD', language: 'English, French' },
    { name: 'Australia', flag: '🇦🇺', heroImage: 'https://picsum.photos/seed/australia-outback/1920/1080', dataAiHint: 'australia outback', tagline: 'The Land Down Under', continent: 'Australia', culture: 'Aboriginal heritage and laid-back beach culture.', bestTime: 'Sep-Nov, Mar-May', currency: 'AUD', language: 'English' },
    { name: 'Italy', flag: '🇮🇹', heroImage: 'https://picsum.photos/seed/italy-amalfi/1920/1080', dataAiHint: 'italy amalfi', tagline: 'La Dolce Vita', continent: 'Europe', culture: 'Rich in art, history, fashion, and culinary delights.', bestTime: 'Apr-Jun, Sep-Oct', currency: 'EUR', language: 'Italian' },
    { name: 'Vietnam', flag: '🇻🇳', heroImage: 'https://picsum.photos/seed/vietnam-halong-bay/1920/1080', dataAiHint: 'vietnam halong bay', tagline: 'The Timeless Charm of Southeast Asia', continent: 'Asia', culture: 'Resilient history, vibrant street life, and flavorful cuisine.', bestTime: 'Mar-Apr, Sep-Nov', currency: 'VND', language: 'Vietnamese' },
    { name: 'Argentina', flag: '🇦🇷', heroImage: 'https://picsum.photos/seed/argentina-patagonia/1920/1080', dataAiHint: 'argentina patagonia', tagline: 'The Land of Silver', continent: 'South America', culture: 'Tango, football, and vast, dramatic landscapes.', bestTime: 'Oct-Nov, Mar-Apr', currency: 'ARS', language: 'Spanish' },
    { name: 'Egypt', flag: '🇪🇬', heroImage: 'https://picsum.photos/seed/egypt-pyramids/1920/1080', dataAiHint: 'egypt pyramids', tagline: 'The Gift of the Nile', continent: 'Africa', culture: 'Home to pharaohs, pyramids, and ancient wonders.', bestTime: 'Oct-Apr', currency: 'EGP', language: 'Arabic' },
    { name: 'India', flag: '🇮🇳', heroImage: 'https://picsum.photos/seed/india-taj-mahal/1920/1080', dataAiHint: 'india taj mahal', tagline: 'Incredible India', continent: 'Asia', culture: 'A diverse tapestry of religions, languages, and traditions.', bestTime: 'Oct-Mar', currency: 'INR', language: 'Hindi, English' },
    { name: 'UAE', flag: '🇦🇪', heroImage: 'https://picsum.photos/seed/uae-dubai-skyline/1920/1080', dataAiHint: 'uae dubai skyline', tagline: 'The Land of Seven Emirates', continent: 'Asia', culture: 'A blend of Bedouin heritage and futuristic ambition.', bestTime: 'Oct-Apr', currency: 'AED', language: 'Arabic' },
    { name: 'Thailand', flag: '🇹🇭', heroImage: 'https://picsum.photos/seed/thailand-beaches/1920/1080', dataAiHint: 'thailand beaches', tagline: 'The Land of Smiles', continent: 'Asia', culture: 'Ornate temples, bustling markets, and stunning beaches.', bestTime: 'Nov-Apr', currency: 'THB', language: 'Thai' },
    { name: 'Cambodia', flag: '🇰🇭', heroImage: 'https://picsum.photos/seed/cambodia-angkor-wat/1920/1080', dataAiHint: 'cambodia angkor wat', tagline: 'Kingdom of Wonder', continent: 'Asia', culture: 'Ancient Khmer temples and resilient, friendly people.', bestTime: 'Nov-Mar', currency: 'KHR', language: 'Khmer' },
    { name: 'Singapore', flag: '🇸🇬', heroImage: 'https://picsum.photos/seed/singapore-gardens/1920/1080', dataAiHint: 'singapore gardens', tagline: 'The Lion City', continent: 'Asia', culture: 'A multicultural hub of food, architecture, and innovation.', bestTime: 'Feb-Apr', currency: 'SGD', language: 'English, Mandarin, Malay, Tamil' },
    { name: 'Malaysia', flag: '🇲🇾', heroImage: 'https://picsum.photos/seed/malaysia-kl-towers/1920/1080', dataAiHint: 'malaysia kl towers', tagline: 'Truly Asia', continent: 'Asia', culture: 'A fusion of Malay, Chinese, Indian, and indigenous cultures.', bestTime: 'Mar-Oct', currency: 'MYR', language: 'Malay' },
    { name: 'South Korea', flag: '🇰🇷', heroImage: 'https://picsum.photos/seed/korea-seoul-palace/1920/1080', dataAiHint: 'korea seoul palace', tagline: 'The Land of the Morning Calm', continent: 'Asia', culture: 'A dynamic mix of ancient history and modern pop culture.', bestTime: 'Apr-Jun, Sep-Nov', currency: 'KRW', language: 'Korean' },
    { name: 'France', flag: '🇫🇷', heroImage: 'https://picsum.photos/seed/france-eiffel-tower/1920/1080', dataAiHint: 'france eiffel tower', tagline: 'The City of Light', continent: 'Europe', culture: 'Art, gastronomy, fashion, and revolutionary history.', bestTime: 'Apr-Jun, Sep-Oct', currency: 'EUR', language: 'French' },
    { name: 'Spain', flag: '🇪🇸', heroImage: 'https://picsum.photos/seed/spain-barcelona/1920/1080', dataAiHint: 'spain barcelona', tagline: 'The Kingdom of the Sun', continent: 'Europe', culture: 'Flamenco, tapas, siestas, and stunning architecture.', bestTime: 'Apr-Oct', currency: 'EUR', language: 'Spanish' },
];
